...
- **Selection**, which performs opertations `ìf` or unless certain conditions are met; 
- **Iteration**, which iteratively `repeat`s an operation `while`, `until` or `for` a determined number of times; 
- **Procedural abstraction**, which involes a subroutine, nested call;
- Recursion
