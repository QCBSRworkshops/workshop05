...
.center[.alert[Bonus points] for doing it with nested loops!]
...
1. Variables defined .alert[inside] a function are not accessible outside of it!

2. Variables defined .alert[outside] a function are accessible inside. But we caution about using this often, as your function will not function if the outside variable is erased.

<br>

<br>

.center[Include short examples!]
...
.alert[Mandatory tip.] **Use arguments!**
